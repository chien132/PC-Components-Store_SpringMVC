							...
							<div class="col-lg-12">
								<div class="card shadow-lg border-0 rounded-lg mt-5">
									...
									<div class="card-body" style="min-height: 80vh;">
										<form:form action="admin/${action}.htm" modelAttribute="p"
												...
												<div class="col-lg-9">
														...
														<div class="col-md-4">
															<div class="form-group">
																...
																<form:input type="number" min="0" max="100" step="1"
																	path="discount" required="required"
																	class="form-control" />
															</div>
														</div>
														<div class="col-md-4">
													...
													<div class="form-row">
														<div class="col-md-12">
															<div class="form-group">
																...
																<form:textarea type="text" path="des"
																	required="required" class="form-control" />
													...
													<div class="form-group mt-4 mb-0">
														...
														<button class="btn btn-primary btn-block"
															onclick="location.href='admin/index.htm'" type="button">Cancel</button>
													</div>
												</div>
												<div class="col-lg-3">
													<img id="thisimage"
