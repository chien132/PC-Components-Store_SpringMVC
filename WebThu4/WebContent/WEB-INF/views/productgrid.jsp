                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-2 col-sm-2">
                                <div class="logo">
                                    <a href="index.htm"> <img src="images/logo.png" alt="FlatShop">
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <c:forEach var="p" items="${products}">
                                            <div class="col-md-4 col-sm-6">
                                                <div class="products">
                                                    <div class="thumbnail">
                                                        <a href="details.htm"> <img src="${p.image}" style="max-height: 100%  ">
                                                        </a>
                                                    </div>
...
">Price</option>
                        ...
                        <div class="our-brand">
                            ...
                            <div class="control">
                                <a id="prev_brand" class="prev" href="#"> &lt; </a> <a id="next_brand" class="next" href="#">
							&gt; </a>
                            </div>
                            <ul id="braldLogo">
                                <li>
