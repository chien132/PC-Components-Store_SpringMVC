                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <ul class="option">
                                                    ...
                                                    <li class="option-cart"><a href="cart.htm" class="cart-icon">cart <span class="cart_no"><c:if
                                                                ...
                                                                <c:forEach var="bi" items="${cartitem}">
                                                                    <li>
                                                                        <div class="cart-item">
                                                                            ...
                                                                            <div>
                                                                                <p class="price">
                                                                                    <f:formatNumber type="currency" currencySymbol="" maxFractionDigits="0" value="${bi.product.price*bi.amount*(100-bi.product.discount)/100}" /> đ
                                                                                </p>
                                                                                <a href="removeitem/${bi.id}/index.htm" class="remove"><img src="images/remove.png" alt="remove"></a>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                </c:forEach>
