                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-2 col-sm-2">
                                    <div class="logo">
                                        <a href="index.htm"> <img src="images/logo.png" alt="XGear">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-10 col-sm-10">
                                    ...
                                    <div class="header_bottom">
                                        <ul class="option">
                                            ...
                                            <li class="option-cart"><a href="#" class="cart-icon">
										cart <span class="cart_no"> 02 </span>
								</a>
                                                <ul class="option-cart-item">
                                                    <li>
                                                        <div class="cart-item">
                                                            ...
                                                            <div class="item-description">
                                                                ...
                                                                <p>
                                                                    Size: <span class="light-red"> One size </span> <br> Quantity: <span class="light-red"> 01 </span>
                                                                </p>
                                                            </div>
                                                            <div class="right">
                                                                <p class="price">$30.00</p>
                                                                <a href="#" class="remove"> <img src="images/remove.png" alt="remove">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li><span class="total"> Total <strong>
													$60.00 </strong>
										</span>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 col-sm-6">
                                                                <ul class="mega-menu-links">
                                                                    ...
                                                                    <li><a href="productgrid.htm"> Blazers & Jackets
														</a></li>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="products-list">
                                        <div class="toolbar">
                                            <div class="sorter">
                                                <div class="view-mode">
                                                    <a href="#" class="list active"> List </a> <a href="productgrid.htm" class="grid"> Grid </a>
                                                </div>
                                                <div class="sort-by">
                                                    Sort by : <select name="">
                                                ...
                                                <li class="products">
                                                    ...
                                                    <div class="product-list-description">
                                                        ...
                                                        <div class="list_bottom">
                                                            <div class="price">
                                                                <span class="new_price"><f:formatNumber type="currency" maxFractionDigits="0"><f:parseNumber integerOnly="true"> ${p.price*(1-p.discount)}</f:parseNumber></f:formatNumber> <sup>
															đ </sup>
